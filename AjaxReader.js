...
function placeContent(){
  ...
  strContent += "<h2 class='author'>by" + blogPostInfo.author + "</h2>";
  strContent += "<h2 class='authorsTitle'>" + blogPostInfo.authorsTitle + "</h2>";
  strContent += "<h3 class='locationLabel'> delivered at:</h3>";
  strContent += "<h3 class='location'>" + blogPostInfo.location + "</h3>";
  strContent += "<h3 class='date'>" + blogPostInfo.date + "</h3>";
